				...
				<ul id="comment-list" class="comment-list">
					<c:forEach items="${travellers}" var="traveller">
						<li class="fn-clear">
							<div >
								<p>
									<a class="comment_user" href="${pageContext.request.contextPath }/travellerDetail.do?tkid=${traveller.tkid}">${traveller.tktitle}</a>
									<label style="float:right"><a class="comment_user" href="${pageContext.request.contextPath }/travellerDelete.do?tkid=${traveller.tkid}">删除</a></label>
								</p>
								<div class="comment_box">
									<div class="comment_cnt"> 
										目的地：${traveller.tkdestination}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										行程：<fmt:formatDate value="${traveller.tkbegintime}" pattern="yyyy-MM-dd  HH:mm"/> 至 <fmt:formatDate value="${traveller.tkaftertime}" pattern="yyyy-MM-dd  HH:mm"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										发布时间：<fmt:formatDate value="${traveller.tktime}" pattern="yyyy-MM-dd  HH:mm:ss"/>
                                    </div>
                                </div>
                            </div>
                        </li>
